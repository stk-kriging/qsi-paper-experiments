...
nb_runs = 1;  % Number of runs of the different algorithms.
nb_cores = maxNumCompThreads-1; %Number of computing core to use.

%Set to 0 to ignore a test function.
DO_F1 = 1;
DO_F2 = 1;
DO_F3 = 1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% f_1 synthethic function (branin_mod)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if DO_F1
    ...
    xlabel("steps")
    ylabel("prop. misclass")
    title(sprintf("Quantiles 75th (f_1)"))
    ...
    xlabel("steps")
    ylabel("prop. misclass")
    title(sprintf("Quantiles 95th (f_1)"))
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% f_2 synthethic function (double_camel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
